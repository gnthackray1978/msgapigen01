...
namespace Api.Models
{
    ...
    .HasName("east_or_west");
        ...
        public static List<FTMLatLng> ListLatLongs(String connectionString, int yearFrom, int yearTo)
        {
            ...
            String commandText = "SELECT BirthLat ,BirthLong ,count(id) AS Count FROM [DNA].[FTMPersonView] WHERE (birthlat<> 0 and birthlong <> 0) and (birthto > @yearFrom and birthto < @yearTo) GROUP BY birthlat, birthlong";
