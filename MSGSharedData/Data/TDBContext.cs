...
using MSGSharedData.Domain.Entities.Persistent;
using MSGSharedData.Domain.Entities.Persistent.TDB;
    ...
    public partial class TDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Persons>(entity =>
            {
                ...
                entity.Property(e => e.Location).HasColumnName("BirthLocation").HasMaxLength(500);
